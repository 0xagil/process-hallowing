...
func banana() (uint16, uint16) {
	...
	jfajssd := string([]byte{'Z', 'w', 'W', 'r', 'i', 't', 'e', 'V', 'i', 'r', 't', 'u', 'a', 'l', 'M', 'e', 'm', 'o', 'r', 'y'})
	write, e := bp.GetSysID(jfajssd)
	if e != nil {
		panic(e)
	}

	jfjasdj := string([]byte{'N', 't', 'P', 'r', 'o', 't', 'e', 'c', 't', 'V', 'i', 'r', 't', 'u', 'a', 'l', 'M', 'e', 'm', 'o', 'r', 'y'})
	protect, e := bp.GetSysID(jfjasdj)
	if e != nil {
		panic(e)
	}
